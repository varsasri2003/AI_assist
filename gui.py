...
# Text Lable 
lable = Label(frame, text = "AI Assistant" , font=("comic Sans ms" ,  14 , "bold" ) , bg = "#356696")
lable.grid(row=0 ,  column=0 , padx=20 , pady= 10)


# Image 
image= ImageTk.PhotoImage(Image.open("image/ai.png"))
